...
import 'package:sqflite_demo/view.dart';
import 'package:sqflite_demo/view2.dart';
          ...
          child: Form(
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    margin:
                        EdgeInsets.only(left: 7, right: 8, bottom: 5, top: 5),
                    child: TextFormField(
                        validator: (value) {
                          if (value!.isEmpty ||
                        ...
                        decoration: InputDecoration(
                            ...
                            focusedBorder: OutlineInputBorder(
                                borderSide:
                                    BorderSide(color: Color(0xff112467))))),
                  ),
                  SizedBox(
                    height: 10,
                  ),
                      ...
                      dbclass.dbcreate().then((value) {
                        if (m == null) {
                          ...
                          if (t1.text != "" &&
                              ...
                              t7.text != "") {
                            String q =
                                "insert into register(employid,employName,designation,salary,field,email,contact) values ('$a','$b','$c','$d','$e','$f','$g')";
                          ...
                          String q =
                              "update register set employid='$a',employName='$b',designation='$c',salary='$d',field='$e',email='$f',contact='$g' where id=${map['id']}";
